...
Key Highlights: Manual and automated calculation of Regression Coefficients ($b_0$, $b_1$, $b_2$), prediction generation, and model evaluation using metrics like MSE, RMSE, MAE, and R² Score.
...
Key Highlights: Comprehensive benchmarking of K-Means, Hierarchical, and DBSCAN clustering using:Internal Metrics: Silhouette Score, Davies-Bouldin Index, and Calinski-Harabasz Index.External Metrics: Adjusted Rand Index (ARI) and Mutual Information (MI) to compare results against ground truth labels.Tech Stack Used:Libraries: Scikit-Learn (Metrics & Models), NumPy, Pandas, Matplotlib.
